...
Sire uses a shape object that defines fields, field types, and validators. A validation run returns a `Result` object with typed violations, structured error output, and both cast and pristine values.
